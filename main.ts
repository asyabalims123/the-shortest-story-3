...
pause(2000)
game.showLongText("Doğum Günün Kutlu Olsun!", DialogLayout.Bottom)
pause(1000)
game.showLongText("Seni seviyorum", DialogLayout.Bottom)
pause(2000)
game.showLongText("Canım Tunç, her anın yanında olmayı, gülüşüne ortak olmayı ve en içten dostluğunu paylaşmayı çok seviyorum. Seninle geçirdiğim her an, hayatımın en değerli anıları arasında yer alıyor. Ruh eşim, iyi ki varsın; seninle hayallerimizi gerçekleştirmek en büyük mutluluk. Yeni yaşın sana sağlık, neşe ve başarılar getirsin. Hayat yollarımız hep aynı ritimde dans etmeye devam etsin. İyi ki doğdun, seni çok seviyorum! 🎉❤️", DialogLayout.Bottom)
